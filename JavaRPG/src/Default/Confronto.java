    ...
    public void iniciar(Criatura player1, Criatura player2){
        ...
        if(player2.getVida()<0){ 
            ...
            if(player1 instanceof Heroi){
                ...
                System.out.println("O heroi " +player1.getNome()+ " pode descansar. Seu novo HP ̩ " +df.format(player1.getVida())+"\n");
            }else{
            ...
            if(player2 instanceof Heroi){
                ...
                System.out.println("O heroi " +player2.getNome()+ " pode descansar. Seu novo HP ̩ " + df.format(player2.getVida())+"\n");
            }else{
